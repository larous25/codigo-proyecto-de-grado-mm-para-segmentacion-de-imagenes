...
parser = argparse.ArgumentParser(description='Generar gráficos de tiempo de procesamiento.')
parser.add_argument("-lg", "--logarifmic", help="Escala logarítmica.", action='store_true')
...
if __name__ == "__main__":
    # Asegurar que existe la carpeta de plots
    ...
    for cluster in clusters:
        ...
        time_unit = ', s (escala logarítmica)' if LOGARIFMIC else ', s'
        ...
        # Guardar el gráfico
        output_file = f"plots/{cluster}{'_WL' if WITH_WL else ''}.pdf"
